    ...
    <div>
      <div className="flex flex-col gap-20 pt-10 border-b-2 border-black pb-16">
        <div className="flex  justify-center items-center font-medium font-kelly-slab text-2xl text-text-primary ">
          <h1 className="border-b-4 border-[#0D3167]">PPROJECTS</h1>
        </div>
        <div className="flex flex-row  justify-around">
          ...
          <div className="flex flex-col gap-12 self-center">
            <h1 className="text-2xl font-bold text-text-primary self-center">
              ai-visuage
            </h1>
            ...
            <button className=" bg-text-primary text-white font-kelly-slab w-48 py-2 rounded-md text-xl self-center">
              Case Study
            </button>
          </div>
        </div>
